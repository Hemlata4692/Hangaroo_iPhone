...
//    if (![[UserDefaultManager getValue:@"LoginCred"] isEqualToString:@"hemlata@52.74.174.129"]) {
//        UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
//        self.navigationController = (UINavigationController *)[self.window rootViewController];
//        
//        UIViewController * objReveal = [storyboard instantiateViewControllerWithIdentifier:@"FriendList"];
...
//        //        UIStoryboard * storyboard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
//        //        UIViewController * objReveal = [storyboard instantiateViewControllerWithIdentifier:@"FriendList"];
//        //        //         UIViewController * objReveal = [storyboard instantiateViewControllerWithIdentifier:@"FriendListVC"];
...
-(void)methodCalling{
    ...
    //        [newvCardTemp setNickname:@"shivam"];
